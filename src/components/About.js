          ...
          <div className="row col-xl-6 col-lg-6 col-md-12">
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <ul className="list-1">
                ...
                <li>
                  <h6>
                    <span className="font-weight-600">Birthdate</span>28 December
                    1996
                  </h6>
                </li>
                <li>
                ...
                <li>
                  <h6>
                    <span className="font-weight-600">Experience</span>1.7 years
                  </h6>
                </li>
                <li>
                  <h6>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <ul className="list-2">
                ...
                <li>
                  <h6>
                    <span className="font-weight-600">Phone</span>+976 94262047
                  </h6>
                </li>
                <li>
                  <h6>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <span className="d-block font-weight-400 uppercase">
                        ...
                        <span className="font-weight-700">Obortech</span>
                      </span>
                    </div>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <span className="d-block font-weight-400 uppercase">
                        Web Front end
                        <span className="separator" />
                        <span className="font-weight-700">Oirhon</span>
                      </span>
                    </div>
                    <div className="card-body">
                      <p>
                ...
                <div className="item">
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      Web Front end
                      <span className="separator" />
                        <span className="font-weight-700">international school of ulaanbaatar</span>
                      </span>
                    </div>
                    <div className="card-body">
                        <p>
